...
class TestValidation:
    ...
    async def test_missing_event_id_auto_generated(self) -> None:
        """Empty event_id is auto-generated by Event.create()."""
        bus = EventBus()
        event = Event.create(
            type=EventType.TASK_START,
            session_id="s1",
        ...
        # Event.create() auto-generates event_id if not provided
