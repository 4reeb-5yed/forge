...
| `FORGE_BUILD_TIMEOUT_SECONDS` | No | Build timeout in seconds (default: 1800 = 30 minutes) |
...
| `FORGE_LEARNING_WINDOW_DAYS` | No | Learning analysis window in days (default: 7) |
